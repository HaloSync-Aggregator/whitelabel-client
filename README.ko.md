...
<p align="center">
  <img src="./docs/images/how-it-works.svg" alt="동작 방식 - 3단계 흐름" width="100%">
</p>

### 1단계: 프로비저닝(온보딩)

PolarHub NDC API를 사용하려면 먼저 온보딩을 완료해야 합니다. 온보딩 후 아래 정보를 발급받습니다:
- **Tenant ID** (`POLARHUB_TENANT_ID`): OTA를 구분하는 고유 식별자
...
2. 회사 이메일, 테넌트명, 선택사항인 IATA 번호(Production에서만 필수)를 입력합니다.
3. 약 10분 이내에 샌드박스 자격증명(Tenant ID + Base64 API Secret)이 발급되며, 미들웨어 저장소에 설정합니다.
...
<p align="center">
  <img src="./docs/images/generation-pipeline.svg" alt="생성 파이프라인 - 3단계 에이전트" width="100%">
</p>
